...
class BookingController extends Controller
{
    ...
    {
        $bookings = $this->getDoctrine()->getRepository('InfostanderAdminBundle:Booking')->findBy(
            array(),
    ...
    public function addAction(Request $request)
    {
        ...
        $slides = $this->getDoctrine()->getRepository('InfostanderAdminBundle:Slide')->findBy(
